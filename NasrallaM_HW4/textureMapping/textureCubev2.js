...
var image1 = new Array();
    ...
    for (var i =0; i<texSize; i++) 
	   ...
	   // common method to check if lower order 4 bits of an integral value
	   // 0x8 is hex for 8; in binary it is 1 0 0 0
			// & does a bitwise AND on binary digits
			// value & 0x8 is true when 8/value is odd
			// i=0& 0x8 = 0 and j=0 & 0x8 = 0 ==> false so c=0
			// i=0& 0x8 = 0 and j=8 & 0x8 = 8 ==> true so c=1
			
    for (var i =0; i<texSize; i++) {
		for (var j=0; j<texSize; j++) {
			
			var c = (((i & 0x8) == 0) ^ ((j & 0x8)  == 0));
			//console.log("i=",i,"j=",j,"  i&0x8 =",(i & 0x8),"  j&  =",(j & 0x8),"  c=",c);
			image1[i][j] = [c, c, c, 1];
		}
	}
